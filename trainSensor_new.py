...
def main(args):
    ...
    train_dataset= CoralDataset3D(dir_train,transform, 0, k=5, excluded=['1490','1491','1492','1493'])
    val_dataset = CoralDataset3D(dir_val,transform, 1, k=5,excluded=['1620','1621','1622','1623'], direction=-1)
    # n_val = 50
